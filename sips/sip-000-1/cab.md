...
per the procedure described in the Steering Committee’s duties (link to sc file).  Each
...
Consideration Advisory Board may adopt its own bylaws (link to usable bylaw) for selecting members and
...
to store and publish all feedback for the SIPs it reviews. It shall forward
