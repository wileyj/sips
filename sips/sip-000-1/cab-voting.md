...
- All votes —CAB votes or public on-chain votes—must be held on a stable, review-complete version of the SIP text.
- No substantive changes may be made to a SIP once a vote has begun. Editorial corrections (typos, formatting fixes) may be accepted only with CAB awareness and must not alter intent.
...
- To ensure sufficient review and prevent rushed governance:
    - **Draft Open Comment Period:** minimum _2 weeks_
    - **CAB Review Period:** minimum _1 week_
    - **Final Comment Resolution Period:** minimum _1 week_
...
- A public or ecosystem-wide vote cannot begin until the following is satisfied:
    - The relevant CAB(s) have formally approved the SIP for voting
...
- Minor updates may still be made after the CAB vote and before merge under the following conditions:
    ...
    - Any change must be shared in the relevant CAB communication channel(s), and the diff must be visible in the PR for auditability.
