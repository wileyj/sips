...
other SIP Editors and to the Consideration Advisory Boards. Additionally, once a SIP is accepted, it shall be added to the table of SIPs in the repository README document.

### Recruitment

Each SIP Editor must list their name and contact information in an
easy-to-find location in the SIP repository, as well as a list of each SIP Editor
they have recommended.  In so doing, the SIP Editors shall curate an “invite tree”
