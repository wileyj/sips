...
- Bug fixes to modify incorrectly implemented behavior should only require a CAB vote under the following conditions:
...
_Failure to meet the approval threshold_ results in the SIP being rejected and shall require re-submission as a new SIP
